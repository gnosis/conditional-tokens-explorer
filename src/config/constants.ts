...
export const CONDITION_TOKEN_CONTRACT_ADDRESS_FOR_MAINNET =
  process.env.REACT_APP_CONDITION_TOKEN_CONTRACT_ADDRESS_FOR_MAINNET ||
  '0xC59b0e4De5F1248C1140964E0fF287B192407E0C'
export const CONDITION_TOKEN_CONTRACT_ADDRESS_FOR_RINKEBY =
  process.env.REACT_APP_CONDITION_TOKEN_CONTRACT_ADDRESS_FOR_RINKEBY ||
