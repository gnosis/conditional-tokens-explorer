...
MOCK_GNO_ADDRESS=$(eth contract:deploy --network http://ganache:8545 --pk '0x4f3edf983ac636a65a842ce7c78d9aa706d3b113bce9c46f30d7d21715b23b1d' --abi 'constructor(string,uint8)' --args '["GNO", 18]' ERC20.bin | jq -r .address)
...
echo "mock gno: ${MOCK_GNO_ADDRESS}" >> contracts_addresses.txt
